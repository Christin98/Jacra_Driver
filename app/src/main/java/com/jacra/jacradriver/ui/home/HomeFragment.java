package com.jacra.jacradriver.ui.home;
...
import com.jacra.jacradriver.Common;
import com.jacra.jacradriver.R;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            boolean success = googleMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(getContext(), R.raw.uber_style_map));
            if (!success)
                Log.e("JD_ERROR", "Style parsing error");
        } catch (Resources.NotFoundException e) {
            Log.e("JD_ERROR", e.getMessage());
        }
    }
}